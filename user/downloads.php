...
// Get user's completed orders with downloadable products
$stmt = $connection->prepare("SELECT o.id as order_id, o.created_at as order_date, o.total_amount, o.status, p.id as product_id, p.name as product_name, p.file_path FROM orders o JOIN products p ON o.product_id = p.id WHERE o.user_id = ? AND o.status = 'completed' ORDER BY o.created_at DESC");
if (!$stmt) {
...
<head>
    ...
    <title>My Downloads - YBT Digital</title>
    <!-- MDB Bootstrap CSS -->
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>/user/downloads.php">My Downloads</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="sidebar p-3">
                        ...
                        <a href="<?php echo BASE_URL; ?>/user/downloads.php" class="active"><i class="fas fa-download me-2"></i>Downloads</a>
                ...
                <div class="col-md-9">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3><i class="fas fa-download me-2"></i>My Downloads</h3>
                                    ...
                                    <div class="card download-card h-100">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <h5 class="card-title"><?php echo htmlspecialchars($download['product_name']); ?></h5>
                                            ...
                                            <p class="card-text">
                                                <strong>Order:</strong> #<?php echo $download['order_id']; ?><br>
                                                <strong>Order Date:</strong> <?php echo date('M j, Y', strtotime($download['order_date'])); ?><br>
                                                <strong>Amount:</strong> $<?php echo number_format($download['total_amount'], 2); ?>
                                            </p>
                                            
                                            <div class="mt-3">
                                                <a href="download.php?order_id=<?php echo $download['order_id']; ?>" class="btn btn-primary w-100">
                                                    <i class="fas fa-download me-2"></i>Download File
                                                </a>
                                                <small class="text-muted d-block mt-2">Download your file now</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo BASE_URL; ?>/user/downloads.php" class="text-light text-decoration-none">Downloads</a></li>
