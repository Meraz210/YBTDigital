...
<div class="bg-light py-3">
    <div class="container">
        <h1 class="h3 mb-0">Add New Coupon</h1>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo BASE_URL; ?>/admin/coupons/add">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="min_amount" name="min_amount" step="0.01" min="0" value="0">
